...
export default function ForBusinessesPage() {
  return (
    <div>
      {/* Featured Listing CTA — primary offer for business owners who land here */}
      <section className="bg-amber-50 border-b-2 border-amber-300 py-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-[Cabin] text-2xl md:text-3xl font-bold text-[#1A1A1A] mb-2">
            Own an auto repair shop? Get featured on MechanicSeeker.
          </h2>
          <p className="text-gray-700 max-w-2xl mx-auto mb-5 text-sm md:text-base">
            Priority placement on state, city, and service pages. Photo gallery, customer message form, and monthly performance report. $49.95/mo, cancel anytime.
          </p>
