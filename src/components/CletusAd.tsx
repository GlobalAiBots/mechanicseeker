...
export default function CletusAd() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #1A2332 0%, #2C3E50 60%, #E67E22 100%)",
        opacity: visible ? 1 : 0,
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="bg-[#E67E22] hover:bg-[#d35400] text-white font-bold text-sm px-6 py-3 rounded-lg transition shadow-lg shadow-black/20"
              >
